...
from algorithms_and_data_structures.second_laboratory.first_question.quick import quick_sort
from algorithms_and_data_structures.second_laboratory.first_question.shell import shell_sort
...
def main() -> None:
    while True:
        choice = input("Введите какой алгоритм вы хотите?\n(1) - быстрая сортировка\n(2) - сортировка Шелла\n")
