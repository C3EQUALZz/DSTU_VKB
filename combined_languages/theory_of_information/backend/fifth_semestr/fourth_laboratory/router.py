...
from combined_languages.theory_of_information.backend.fifth_semestr.fourth_laboratory.dependecies import \
    execute
from combined_languages.theory_of_information.backend.fifth_semestr.fourth_laboratory.schemas import \
    LaboratoryRequest

router = APIRouter(
    prefix="/fifth_semester/fourth_laboratory", tags=["Пятый семестр", "4 лабораторная"]
)
