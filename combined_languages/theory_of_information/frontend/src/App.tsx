...
export function App() {
    ...
    return (
        <>
            <Router>
                <Layout>
                    <Sider width={270} style={{height: '100vh'}} collapsed={collapsed} collapsible trigger={null}
                    ...
                    <Layout>
                        ...
                        <Footer style={{
                            ...
                            <Typography.Text strong style={{
                                ...
                                background: darkTheme ? '#001529' : '#f0f2f5',
                                color: darkTheme ? '#fff' : '#000'
                            }}>Выполнил: Ковалев Данил ВКБ32</Typography.Text>
                            <a href="https://github.com/ваш_профиль" target="_blank" rel="noopener noreferrer"
