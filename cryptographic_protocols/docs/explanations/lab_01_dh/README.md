...
- Подробные логи (раунды Миллера-Рабина и пр.) включены по умолчанию на `INFO`. `RUST_LOG=warn` оставит предупреждения и ошибки. [Общая инструкция по логам](../LOGGING.md).
