...
from ..realisation_classes.word_class import BadPassword, WordBlock


class WordTest(TestCase):
    correct_path: str = (
        "/home/c3equalz/Рабочий стол/Основы информационной безопасности/Лабораторная "
    ...
    def test_path_setter(self):
        ...
        with self.assertRaises(ValueError) as error:
            WordBlock(path)
        self.assertEqual(
            "Неправильный путь к файлу, проверьте снова ", error.exception.args[0]
        )
    ...
    def test_key_error(self):
        ...
        self.assertEqual(
            "Не подходящий ключ для указания значения ", error.exception.args[0]
        )
    ...
    def test_check_correct_password_length(self):
        ...
        self.assertEqual(
            "В вашем пароле должно быть больше 5 символов, обязательно наличие хотя бы одной цифры ",
