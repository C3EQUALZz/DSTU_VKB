...
WITH StudentsWhoPassedExamsInCountOfSubjects AS (SELECT "STUDENT"."STUDENT_ID"
                                                 FROM "STUDENT"
...
INSERT
INTO STUDENT1 ("STUDENT_ID", "SURNAME", "NAME", "STIPEND", "KURS", "CITY", "BIRTHDAY", "UNIV_ID")
SELECT "STUDENT".*
FROM "STUDENT"
         INNER JOIN StudentsWhoPassedExamsInCountOfSubjects
                    ON "STUDENT"."STUDENT_ID" = StudentsWhoPassedExamsInCountOfSubjects."STUDENT_ID";
