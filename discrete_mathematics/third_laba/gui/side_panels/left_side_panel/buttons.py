...
class ButtonPanel(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        for button in (
            ...
            self._create_crypt_button(),
            self._create_decrypt_button(),
        ):
    ...
    def _create_choose_button(self) -> QtWidgets.QPushButton:
        ...
        """
        # Создание кнопки
        choose_button: QtWidgets.QPushButton = QtWidgets.QPushButton(
            "Выбрать фото", self
        )
    ...
    def _create_decrypt_button(self) -> QtWidgets.QPushButton:
        ...
        """
        # Создание кнопки
        decrypt_button: QtWidgets.QPushButton = QtWidgets.QPushButton(
            "Расшифровать", self
        )
        # Подключение кнопки к моему классу Crypt
