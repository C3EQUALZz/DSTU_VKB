...
def test_left_linear_grammar_correct():
    ...
    assert is_left_linear(set_of_terminals=set_of_terminals,
...
def test_left_linear_grammar_incorrect():
    ...
    assert not is_left_linear(set_of_terminals=set_of_terminals,
                              set_of_non_terminals=set_of_non_terminals,
                              grammar=rules)
...
def test_right_linear_grammar_correct():
    ...
    assert is_right_linear(set_of_terminals=set_of_terminals,
                           set_of_non_terminals=set_of_non_terminals,
                           grammar=rules)
...
def test_is_context_free_correct():
    ...
    assert is_context_free(set_of_terminals=set_of_terminals,
                           set_of_non_terminals=set_of_non_terminals,
                           grammar=rules)
...
def test_is_context_free_correct_2():
    ...
    context_free = is_context_free(set_of_terminals=set_of_terminals,
                                   set_of_non_terminals=set_of_non_terminals,
                                   grammar=rules)

    left_linear = is_left_linear(set_of_terminals=set_of_terminals,
                                 set_of_non_terminals=set_of_non_terminals,
                                 grammar=rules)

    right_linear = is_right_linear(set_of_terminals=set_of_terminals,
                                   set_of_non_terminals=set_of_non_terminals,
                                   grammar=rules)
...
def test_is_context_sensitive_correct():
    ...
    context_sensitive = is_context_sensitive(set_of_terminals=set_of_terminals,
                                             set_of_non_terminals=set_of_non_terminals,
                                             grammar=rules)
