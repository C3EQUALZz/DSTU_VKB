...
_CommandTaskIqMapping = Mapping[type[AbstractCommand], AsyncTaskiqDecoratedTask[_FuncParams, _ReturnType]]


class TaskIqScheduler(BaseScheduler):
    def __init__(self, task_name_and_func: _CommandTaskIqMapping) -> None:
        self.task_name_and_func: _CommandTaskIqMapping = task_name_and_func
