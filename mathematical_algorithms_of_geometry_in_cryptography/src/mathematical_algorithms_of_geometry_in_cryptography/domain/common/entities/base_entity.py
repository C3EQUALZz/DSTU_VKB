...
from mathematical_algorithms_of_geometry_in_cryptography.domain.common.errors.base import DomainError
from mathematical_algorithms_of_geometry_in_cryptography.domain.common.errors.time_errors import InconsistentTimeError
