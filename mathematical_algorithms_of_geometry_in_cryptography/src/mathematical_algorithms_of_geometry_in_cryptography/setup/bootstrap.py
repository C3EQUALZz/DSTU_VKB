...
from mathematical_algorithms_of_geometry_in_cryptography.presentation.elliptic_curve_gfp_operations import (
    elliptic_curve_gfp_group,
)
from mathematical_algorithms_of_geometry_in_cryptography.presentation.elliptic_curve_plot import elliptic_curve_group
...
def setup_cli_routes(main_group: Group) -> None:
    ...
    main_group.add_command(elliptic_curve_group)  # type: ignore
    main_group.add_command(elliptic_curve_gfp_group)  # type: ignore
