...
```bash
python cli.py rsa-sign generate-keys -p "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/rsa_pub.txt" -pr "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/rsa_priv.txt" -s 2048 -d 64
```

Подписать документ (war and piece original):

```bash
python cli.py rsa-sign sign -d "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/resources/rsa_sign/warandpeace.txt" -k "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/rsa_priv.txt" -s "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/document.sig" -h "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/hash_document.sha256.txt"
```
...
```bash
python cli.py rsa-sign sign -d "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/resources/rsa_sign/Лабораторная_8.docx" -k "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/rsa_priv.txt" -s "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/Лабораторная_8.sig" -h "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/Лабораторная_8.sha256.txt"
```

Подписать документ (`Лабораторная_8_1.docx`):

```bash
python cli.py rsa-sign sign -d "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/resources/rsa_sign/Лабораторная_8_1.docx" -k "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/rsa_priv.txt" -s "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/Лабораторная_8_1.sig" -h "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/Лабораторная_8_1.sha256.txt"
```

Сравнить хеши:

```bash
python cli.py rsa-sign compare-hashes -h1 "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/Лабораторная_8.sha256.txt" -h2 "/Users/arti/PycharmProjects/DSTU_VKB/methods_and_means_of_cryptographic_information_protection/resources/rsa_sign/Лабораторная_8_1.docx"
```
