...
from cryptography_methods.application.common.views.vigenere import VigenereEncryptView
...
class VigenereEncryptCommand:
    text: str
    key: str


@final
class VigenereEncryptCommandHandler:
    def __init__(
            self,
    ...
    async def __call__(self, data: VigenereEncryptCommand) -> VigenereEncryptView:
        ...
        encrypted_text: Text = self._vigenere_service.encrypt(
            key=keyword,
            text=text_for_encryption,
        )

        return VigenereEncryptView(
