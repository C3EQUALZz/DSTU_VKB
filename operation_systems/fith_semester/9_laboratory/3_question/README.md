...
1. Перейдите в нужную Вам директорию. В моем случае `~/Рабочий стол/Projects/DSTU_VKB/operation_systems/fith_semester/9_laboratory/3_question`

```bash
cd ~/Рабочий стол/Projects/DSTU_VKB/operation_systems/fith_semester/9_laboratory/3_question
```
