...
$html | tee "D:\PycharmProjects\DSTU_VKB\powershell_bash_cmd\operation_systems\fith_semester\2_laboratory\5_question\7_and_8_variant\process_list.html"

# Открываем HTML файл в браузере для проверки (опционально)
Start-Process "D:\PycharmProjects\DSTU_VKB\powershell_bash_cmd\operation_systems\fith_semester\2_laboratory\5_question\7_and_8_variant\process_list.html"
```