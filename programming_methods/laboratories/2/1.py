...
from typing import AnyStr, Sequence, Set
...
def generate_permutations(number: AnyStr) -> Sequence[AnyStr]:
    ...
    unique_letter_permutations: Set[AnyStr] = {
        "".join(p) for p in permutations(letters)
    }
    ...
    for letter in unique_letter_permutations:
        for digit in unique_digit_permutations:
            combined_number = (
                f"{letter[0]}{digit[0]}{digit[1]}{digit[2]}{letter[1]}{letter[2]}"
            )
