...
(
    ...
    product_tsvector tsvector GENERATED ALWAYS AS (to_tsvector('simple', product_id::text)) STORED
);

-- Создание индекса
CREATE INDEX idx_inventory_product ON inventory USING GIST(product_tsvector);
