...
from python_language.formal_languages.seventh_eighth_laboratory.e import DFAMinimizer
...
def main() -> None:
    ...
    n = DFAMinimizer(d.set_of_states, d.set_of_input_alphabet_characters, d.start_state, d.transition_function, d.final_states)
    print(n)
