"""Генератор docx-отчётов по лабораторным курса «Методы тестирования и отладки ПО».

Шаблон титульного листа повторяет эталон из других курсов ДГТУ.
Преподаватель — берётся из меты лабораторной (по умолчанию указано в шаблоне),
год — 2026, студент — Ковалев Д.П. ВКБ43.

Поддерживает три типа вставок:
- add_listing(code, caption) — моноширинный текст (для коротких кусков кода/вывода);
- add_image(path, caption)   — PNG-скриншот (для красивых вставок терминала и кода);
...
STUDENT_GROUP = "ВКБ43"
TEACHER_DEFAULT = "Ковальчик Р.В."
DISCIPLINE = "Методы тестирования и отладки программного обеспечения"
CITY = "Ростов-на-Дону"
YEAR = "2026"
