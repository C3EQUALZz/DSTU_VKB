...
#         encoded_length - 1)) + 1  # -1 to remove overall parity bit from length, +1 since first parity bit at len 1 (2 ** 0)
...
#         for bit in data:
#             out.append(
#                 0 if bit == '0' else 1)  # note that all bits go to 1 if we just append bit, since it's a non-null string
#     return out
#
#
