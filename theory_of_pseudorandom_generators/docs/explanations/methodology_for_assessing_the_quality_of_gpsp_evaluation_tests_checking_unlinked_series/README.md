...
```bash
python cli.py methodology_for_assessing_the_quality_of_gpsp_evaluation_tests_checking_unlinked_series run --linear-congruent-file "/Users/arti/PycharmProjects/DSTU_VKB/theory_of_pseudorandom_generators/linear_congruent.txt" --square-congruent-file "/Users/arti/PycharmProjects/DSTU_VKB/theory_of_pseudorandom_generators/polynomial_congruent.txt" --fibonacci-file "/Users/arti/PycharmProjects/DSTU_VKB/theory_of_pseudorandom_generators/Fibonacci.txt" --geffe-file "/Users/arti/PycharmProjects/DSTU_VKB/theory_of_pseudorandom_generators/Geffe.txt" -m 24 --max-bits 2300
```
